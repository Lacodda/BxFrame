<?php
    ...
    namespace Lacodda\BxFrame\Cli\Agent;
     ...
     * `\Lacodda\BxFrame\Cli\Agent\AgentTask` in the same format: `\Vendor\Package\ClassName::agent()->%method%();`.
    ...
    trait AgentTrait
    {
         ...
         * `\Lacodda\BxFrame\Cli\Agent\AgentTask`. All arguments from this method should
