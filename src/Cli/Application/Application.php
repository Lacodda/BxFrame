<?php
    ...
    namespace Lacodda\BxFrame\Cli\Application;

    use Bitrix\Main\DB\ConnectionException;
    use Bitrix\Main\Loader;
    use Bitrix\Main\ModuleManager;
    use Lacodda\BxFrame\Cli\Agent\Command\OnCronCommand;
    use Lacodda\BxFrame\Cli\Agent\Command\ExecuteCommand;
    use Lacodda\BxFrame\Cli\Application\Exception\ConfigurationException;
    use Lacodda\BxFrame\Cli\Cache\Command\ClearCommand;
    use Lacodda\BxFrame\Cli\Environment\Command\InitCommand;
    use Lacodda\BxFrame\Cli\Module\Command as Module;
    use Lacodda\BxFrame\Cli\Search\Command\ReIndexCommand;
        ...
        extends \Symfony\Component\Console\Application
    {
        ...
        public function doRun (InputInterface $input, OutputInterface $output)
        {
            ...
            {
                $output->writeln (
                    PHP_EOL . '<error>No configuration loaded.</error> ' . 'Please run <info>init</info> command first'
                );
            } else
            {
                switch ($this->getBitrixStatus ())
                {
                    case static::BITRIX_STATUS_UNAVAILABLE:
                        $output->writeln (
                            PHP_EOL . sprintf (
                                '<error>No Bitrix kernel found in %s.</error> ' . 'Please run <info>env:init</info> command to configure',
        ...
        protected function getDefaultCommands ()
        {
            ...
            $commands[] = new \Lacodda\BxFrame\Cli\Application\Command\InitCommand();
