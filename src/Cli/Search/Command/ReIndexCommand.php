<?php
    ...
    namespace Lacodda\BxFrame\Cli\Search\Command;

    use Bitrix\Main\Loader;
    use Bitrix\Main\ModuleManager;
    use Lacodda\BxFrame\Cli\Application\Command\BitrixCommand;
        ...
        extends BitrixCommand
    {
        ...
        protected function execute (InputInterface $input, OutputInterface $output)
        {
            ...
            {
                $output->writeln (
                    '<info>The Social Network module needs to be reindexed using the Social Network component in the public section of site.</info>'
                );
            }
