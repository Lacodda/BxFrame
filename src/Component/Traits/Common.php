<?php
    ...
    namespace Lacodda\BxFrame\Component\Traits;
    ...
    trait Common
    {
        ...
        private function startAjax ()
        {
            ...
            if (strlen ($this->arParams['AJAX_COMPONENT_ID']) <= 0)
            {
                $this->arParams['AJAX_COMPONENT_ID'] =
                    \CAjax::GetComponentID ($this->getName (), $this->getTemplateName (), $this->ajaxComponentIdSalt);
            }
         ...
         * @param \Exception|null|false $exception Exception which will be throwing or "false" what not throwing exceptions. Default — throw new
         *                                         \Exception()
         *
         * @throws \Exception
         */
