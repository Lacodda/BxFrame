<?php
    ...
    abstract class AdminBaseHelper
    {
         ...
         */
        static protected $routerUrl = '/bitrix/admin/bxframe_route.php';
         ...
         * @api
         */
        static protected $entityManager = '\Lacodda\BxFrame\Module\EntityManager';
        ...
        public static function setInterfaceSettings (array $settings, array $helpers = array (), $module = '')
        {
            foreach ($helpers as $helperClass => $helperSettings)
            {
                ...
                { // поддержка старого формата описания хелперов
        ...
        {
            if (isset(self::$interfaceSettings[$module][static::getViewName ()]) || empty($module) || empty($interfaceSettings))
            {
                return false;
            }
        ...
        protected function getButton ($code, $params, $keys = array ('name', 'TEXT'))
        {
            ...
            $text = $this->lang->getMessage ($code);
        ...
        public function addNotes ($notes)
        {
            ...
            {
                $_SESSION['ELEMENT_SAVE_NOTES'] = array_merge (
                    $_SESSION['ELEMENT_SAVE_NOTES'],
                    $notes
                );
            } else
            {
         ...
         *
         * @return bool|\Lacodda\BxFrame\Module\Widget\HelperWidget
         *
         * @throws \Lacodda\BxFrame\Module\Helper\Exception
         *
         * @internal
         */
        ...
        public static function getHLEntity ($className)
        {
            if (!class_exists ($className))
            {
                ...
                {
                    $error = $this->lang->getMessage ('GETMODEL_EXCEPTION', array ('#CLASS#' => $className));
        ...
        public static function getHLEntityInfo ($className)
        {
            ...
            return HL\HighloadBlockTable::getList ($parameters)
                                        ->fetch ();
        }
