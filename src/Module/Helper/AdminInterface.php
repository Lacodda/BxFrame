<?php
    ...
    abstract class AdminInterface
    {
         ...
         * array(
         *    'TAB_1' => array(
         *        'NAME' => $this->lang->getMessage('VENDOR_MODULE_ENTITY_TAB_1_NAME'),
         *        'FIELDS' => array(
         *            'FIELD_1' => array(
         *                'WIDGET' => new StringWidget(),
         *                'TITLE' => $this->lang->getMessage('VENDOR_MODULE_ENTITY_FIELD_1_TITLE'),
         *                ...
         *            ),
         *            'FIELD_2' => array(
         *                'WIDGET' => new NumberWidget(),
         *                'TITLE' => $this->lang->getMessage('VENDOR_MODULE_ENTITY_FIELD_2_TITLE'),
         *                ...
         *            ),
         *            ...
         *        )
         *    ),
         *    'TAB_2' => array(
         *        'NAME' => $this->lang->getMessage('VENDOR_MODULE_ENTITY_TAB_2_NAME'),
         *        'FIELDS' => array(
         *            'FIELD_3' => array(
         *                'WIDGET' => new DateTimeWidget(),
         *                'TITLE' => $this->lang->getMessage('VENDOR_MODULE_ENTITY_FIELD_3_TITLE'),
         *                ...
         *            ),
         *            'FIELD_4' => array(
         *                'WIDGET' => new UserWidget(),
         *                'TITLE' => $this->lang->getMessage('VENDOR_MODULE_ENTITY_FIELD_4_TITLE'),
         *                ...
         *            ),
         *            ...
         *        )
         ...
         *
         * @see Lacodda\BxFrame\Module\Widget\HelperWidget
         *
         * @return array[]
         */
         ...
         *        'BUTTONS' => array(
         *            'RETURN_TO_LIST' => array('TEXT' => $this->lang->getMessage('VENDOR_MODULE_ENTITY_RETURN_TO_LIST')),
         *            'ADD_ELEMENT' => array('TEXT' => $this->lang->getMessage('VENDOR_MODULE_ENTITY_ADD_ELEMENT'),
         *            ...
         *        )
         *    ),
         *    '\Vendor\Module\Entity\AdminInterface\EntityEditHelper' => array(
         *        'BUTTONS' => array(
         *            'LIST_CREATE_NEW' => array('TEXT' => $this->lang->getMessage('VENDOR_MODULE_ENTITY_LIST_CREATE_NEW')),
         *            'LIST_CREATE_NEW_SECTION' => array('TEXT' => $this->lang->getMessage('VENDOR_MODULE_ENTITY_LIST_CREATE_NEW_SECTION'),
         *            ...
         *        )
         *    )
         * )
         ...
         *
         * @see \Lacodda\BxFrame\Module\Helper\AdminBaseHelper::getButton()
         *
         * @return string[]
         */
