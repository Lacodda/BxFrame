<?php
        ...
        extends HelperWidget
    {
        ...
        public function generateRow (&$row, $data)
        {
            ...
            {
                $value = $this->lang->getMessage ('CHECKBOX_YES');
            } else
            {
                $value = $this->lang->getMessage ('CHECKBOX_NO');
            }
        ...
        public function showFilterHtml ()
        {
            ...
            $langYes = $this->lang->getMessage ('CHECKBOX_YES');
            $langNo = $this->lang->getMessage ('CHECKBOX_NO');
        ...
        public function getValueReadonly ()
        {
            ...
            switch ($modeType)
            {
                ...
                {
                    $value = $value == 'Y' ? $this->lang->getMessage ('CHECKBOX_YES') : $this->lang->getMessage ('CHECKBOX_NO');
                    break;
                }
                case static::TYPE_INT:
                case static::TYPE_BOOLEAN:
                {
                    $value = $value ? $this->lang->getMessage ('CHECKBOX_YES') : $this->lang->getMessage ('CHECKBOX_NO');
                    break;
                }
            }
