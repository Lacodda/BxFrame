<?php
        ...
        extends HelperWidget
    {
        ...
        protected function getComboBox ($multiple = false, $forFilter = false)
        {
            ...
            if (empty($variants))
            {
                $comboBox = $this->lang->getMessage ('MISSING_VARIANTS');
            } else
            {
                ...
                foreach ($variants as $variant)
                {
                    ...
                    $comboBox .= "<option value='" .
                        static::prepareToTagAttr ($variant['ID']) .
                        "' " .
                        ($selected ? "selected" : "") .
                        ">" .
                        static::prepareToTagAttr ($variant['TITLE']) .
                        "</option>";
                }
        ...
        protected function getMultipleValueReadonly ()
        {
            ...
            if (empty($variants))
            {
                $result = $this->lang->getMessage ('MISSING_VARIANTS');
            } else
            {
