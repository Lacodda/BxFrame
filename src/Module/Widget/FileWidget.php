<?php
        ...
        extends HelperWidget
    {
        ...
        protected function getEditHtml ()
        {
            ...
            {
                $html = \CFileInput::Show (
                    $this->getEditInputName ('_FILE'),
        ...
        public function processEditAction ()
        {
                ...
                if (!empty($_FILES[$this->getCode ()]))
                {
                    foreach ($_FILES[$this->getCode ()]['name'] as $key => $fileName)
                    {
                        ...
                        )
                        {
                            ...
                            {
                                \CFile::UpdateDesc (
                                    $this->data[$this->getCode ()][$key]['VALUE'],
            ...
            } else
            {
                if (class_exists ('\Bitrix\Main\UI\FileInput', true) && $this->getSettings ('IMAGE') === true)
                {
                    if (is_array ($this->data[$this->code . '_FILE']) &&
                        ($this->data[$this->code . '_FILE']['name'] || $this->data[$this->code . '_FILE']['tmp_name'])
                    )
                    {
