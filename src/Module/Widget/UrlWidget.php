        ...
        extends StringWidget
    {
        ...
        public function getValue ()
        {
            ...
            if ($value !== null)
            {
                ...
                if (($this->getSettings ('READONLY') && $this->getCurrentViewType () == static::EDIT_HELPER) ||
                    $this->getCurrentViewType () == static::LIST_HELPER
                )
                {
        ...
        public function processEditAction ()
        {
            ...
            if ($this->getSettings ('PROTOCOL_REQUIRED') && !empty($value) && preg_match ('/^https?:\/\//', $value) == 0)
            {
